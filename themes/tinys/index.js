...
const LayoutIndex = props => {
    ...
    return (
        <>
            ...
            {/* 
             * 合作伙伴/品牌展示部分
             * 通过 PROXIO_BRANDS_ENABLE 配置是否显示
             * 可以修改 Brand 组件来自定义:
             * - 品牌 logo
             * - 合作伙伴信息
             * - 展示布局
            ...
            {/* 
             * 生涯/时间线展示部分
             * 通过 PROXIO_CAREER_ENABLE 配置是否显示
             * 可以修改 Career 组件来自定义:
             * - 时间线内容
             * - 重要事件
             * - 展示样式
            ...
            {/* 
             * 产品特性展示部分
             * 通过 PROXIO_FEATURE_ENABLE 配置是否显示
             * 可以修改 Features 组件来自定义:
             * - 功能特性列表
             * - 图标和描述
             * - 布局方式
             */}
            ...
            {/* 
             * 用户评价/推荐展示部分
             * 通过 PROXIO_TESTIMONIALS_ENABLE 配置是否显示
             * 可以修改 Testimonials 组件来自定义:
             * - 用户评价内容
             * - 用户头像和信息
             * - 展示效果
             */}
            ...
            {/* 
             * 行动号召(Call to Action)部分
             * 通过 PROXIO_CTA_ENABLE 配置是否显示
             * 可以修改 CTA 组件来自定义:
             * - 标题和描述文案
             * - 按钮样式和链接
             * - 背景和布局
            ...
            {/* 
             * 欢迎页面覆盖层
             * 通过 PROXIO_WELCOME_COVER_ENABLE 配置是否显示
             * 默认为 false
             * 可以修改 LoadingCover 组件来自定义:
             * - 加载动画
             * - 欢迎文案
             * - 显示效果
             */}
