...
const CONFIG = {
    ...
    PROXIO_HERO_TITLE_1: '嗨，我是ImageTinys', // 主标题
    PROXIO_HERO_TITLE_2: '一位居住在广州的跨学科动态设计师', // 副标题
    
    // 英雄区按钮配置
    PROXIO_HERO_BUTTON_1_TEXT: '开始体验', // 按钮1文字
    PROXIO_HERO_BUTTON_1_URL: 'https://docs.tangly1024.com/article/vercel-deploy-notion-next', // 按钮1链接
    PROXIO_HERO_BUTTON_2_TEXT: '在Github上关注', // 按钮2文字
    PROXIO_HERO_BUTTON_2_URL: 'https://github.com/tangly1024/NotionNext', // 按钮2链接
    PROXIO_HERO_BUTTON_2_ICON: '/images/starter/github.svg', // 按钮2图标

    // 英雄区背景配置
    PROXIO_HERO_BANNER_IMAGE: '', // 背景图片URL，留空则使用默认
    PROXIO_HERO_BANNER_IFRAME_URL: '', // 背景嵌入页面URL，可用于显示动画等

    /* ===== 博客文章区配置 ===== */
    PROXIO_BLOG_ENABLE: true, // 是否显示博客区
    PROXIO_BLOG_TITLE: '作品', // 博客区标题
    PROXIO_BLOG_COUNT: -1, // 显示所有文章
    PROXIO_BLOG_TEXT_1: '我的最新动态',

    // 博客区图片占位符配置
    PROXIO_BLOG_PLACEHOLDER_IMG_URL_1: '', // 文章1默认图片
    PROXIO_BLOG_PLACEHOLDER_IMG_URL_2: '', // 文章2默认图片
    PROXIO_BLOG_PLACEHOLDER_IMG_URL_3: '', // 文章3默认图片
    ...
    // 特性1配置
    PROXIO_FEATURE_1_ICON_CLASS: 'fa-solid fa-stopwatch', // Font Awesome图标类名
    PROXIO_FEATURE_1_ICON_IMG_URL: '', // 自定义图标URL
    ...
    PROXIO_TESTIMONIALS_TEXT_2: '数千位站长选择用NotionNext搭建他们的网站,通过帮助手册、交流社群以及技术咨询，大家成功上线了自己的网站',
    ...
    PROXIO_ABOUT_TEXT_1: '嗨，我是ImageTinys',
    PROXIO_ABOUT_TEXT_2:
        '一位居住在广州的跨学科动态设计师，专注动态设计领域，擅长以AE/C4D为核心全流程构建动态影片，作为一个自学成才的人，我总是在学习新事物，不断寻找新的想法',
    PROXIO_ABOUT_PHOTO_URL: 'https://www.notion.so/image/attachment%3A8aa85ad4-549d-4018-a653-158ab6d824bb%3A2024.png?table=block&id=1ea10fc2-aff7-809e-bdeb-d2972879f5fb&spaceId=2541d7ab-e6a4-4b3f-977d-d49766a51ba9&width=2000&userId=2dc26148-5fa5-4ac6-ab72-73df8effba80&cache=v2',
